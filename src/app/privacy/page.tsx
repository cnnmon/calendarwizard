  ...
  return (
    <div className="flex flex-col gap-4 p-4 bg-white">
      ...
      <h2 className="text-xl font-medium">
        Privacy Policy for Wizarding Assistant
      </h2>
      <p className="text-sm text-gray-500">Last updated: January 04, 2025</p>
      ...
      <p className="text-sm text-gray-500">
        This Privacy Policy has been created with the help of the Free Privacy
        Policy Generator.
      </p>
      ...
      <ul className="list-disc pl-8">
        ...
        <li>
          ...
          this Agreement) refers to Wizarding Assistant.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Wizarding Assistant, accessible
          from https://wizardingassistant.vercel.app/
        </li>
        <li>
      ...
      <p>
        Learn more about cookies on the Free Privacy Policy website article. We
      ...
      <ul className="list-disc pl-8">
        <li>By email: tiffanywang@berkeley.edu</li>
      </ul>
